(function() {
   ...
   function main() {
      var test_section = job_info.xmlElements[1].xmlElements[2];
      alert(section_string(test_section));
      //var contract_info = contract_to_aoa(job_info);      

      alert(contract_info[0].toString());
   }
